...
#### Prod Repo
url --url=https://dl.fedoraproject.org/pub/fedora/linux/releases/43/Server/x86_64/os/
# url --url=https://mirrors.edge.kernel.org/fedora/releases/43/Everything/x86_64/os/

#### Archive Repo
# url --url=https://archives.fedoraproject.org/pub/archive/fedora/linux/releases/43/Everything/x86_64/os/
