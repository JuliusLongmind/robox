...
network --device eth0 --bootproto dhcp --noipv6 --hostname=fedora43.localdomain
...
#### Prod Repo
url --url=https://dl.fedoraproject.org/pub/fedora/linux/releases/43/Server/aarch64/os/
# url --url=https://mirrors.edge.kernel.org/fedora/releases/43/Everything/aarch64/os/

#### Archive Repo
# url --url=https://archives.fedoraproject.org/pub/archive/fedora/linux/releases/43/Everything/aarch64/os/
